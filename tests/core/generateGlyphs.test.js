...
describe('generateGlyphs', () => {
  ...
  test('should return correctly generate simple string glyphs', () => {
    ...
    expect(R.pluck('xAdvance', result.runs[0].positions)).toEqual([8, 8, 8, 8, 8]);
  });
  ...
  test('should return correctly generate ligature glyphs', () => {
    ...
    expect(R.pluck('xAdvance', result.runs[0].positions)).toEqual([8, 8, 10, 8]);
  });
  ...
  test('should return correctly generate multi ligature glyphs', () => {
    ...
    expect(R.pluck('id', result.runs[0].glyphs)).toEqual([76, 111, 64257, 109, 64259, 100, 111]);
    expect(R.pluck('xAdvance', result.runs[0].positions)).toEqual([8, 8, 10, 8, 10, 8, 8]);
  });
  ...
  test('should return correctly generate glyphs starting with ligature', () => {
    ...
    expect(R.pluck('id', result.runs[0].glyphs)).toEqual([64257, 108, 111, 109]);
    expect(R.pluck('xAdvance', result.runs[0].positions)).toEqual([10, 8, 8, 8]);
  });
  ...
  test('should return correctly generate glyphs ending with ligature', () => {
    ...
    expect(R.pluck('xAdvance', result.runs[0].positions)).toEqual([8, 8, 8, 10]);
  });

...
describe('run ascent operator', () => {
  ...
  test('should return correct font ascent', () => {
    const run = { attributes: { fontSize: 12, font: { ascent: 10, unitsPerEm: 2 } } };
  ...
  test('should return correct font ascent with shortest attachment', () => {
    const run = {
      attributes: { fontSize: 12, attachment: { height: 5 }, font: { ascent: 10, unitsPerEm: 2 } }
    };
  ...
  test('should return attachment height if taller', () => {
    const run = {
      attributes: { fontSize: 12, attachment: { height: 70 }, font: { ascent: 10, unitsPerEm: 2 } }
    };

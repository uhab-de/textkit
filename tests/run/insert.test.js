...
describe('run insert glyph operator', () => {
  ...
  test('should insert glyph at middle of run', () => {
    ...
    expect(result).toHaveProperty('end', 6);
    expect(result).toHaveProperty('glyphIndices', [0, 1, 2, 3, 4, 5]);
    expect(R.pluck('id', result.glyphs)).toEqual([76, 111, 105, 114, 101, 109]);
  ...
  test('should insert ligature glyph at beggining of run', () => {
    ...
    expect(R.pluck('id', result.glyphs)).toEqual([64257, 76, 111, 114, 101, 109]);
    expect(R.pluck('xAdvance', result.positions)).toEqual([10, 5, 6, 7, 8, 9]);
  });
  ...
  test('should insert ligature glyph at end of run', () => {
    ...
    expect(R.pluck('id', result.glyphs)).toEqual([76, 111, 114, 101, 109, 64257]);
    expect(R.pluck('xAdvance', result.positions)).toEqual([5, 6, 7, 8, 9, 10]);
  });
  ...
  test('should insert ligature glyph at middle of run', () => {
    ...
    expect(R.pluck('id', result.glyphs)).toEqual([76, 111, 64257, 114, 101, 109]);
    expect(R.pluck('xAdvance', result.positions)).toEqual([5, 6, 10, 7, 8, 9]);
  });
...
describe('run insert code point operator', () => {
  ...
  test('should insert code point at middle of run', () => {
    ...
    expect(result).toHaveProperty('glyphIndices', [0, 1, 2, 3, 4, 5]);
    expect(R.pluck('id', result.glyphs)).toEqual([76, 111, 105, 114, 101, 109]);
    expect(R.pluck('xAdvance', result.positions)).toEqual([5, 6, 8, 7, 8, 9]);
  });
  ...
  test('should insert code point before run ligature', () => {
    ...
    expect(result).toHaveProperty('glyphIndices', [0, 1, 2, 3, 3, 4]);
    expect(R.pluck('id', result.glyphs)).toEqual([76, 105, 111, 64257, 109]);
    expect(R.pluck('xAdvance', result.positions)).toEqual([5, 8, 6, 7, 8]);
  });
